...
const TrainerCard = ({ trainer }) => {
  ...
  return (
    ...
    // </div>
    <>
    <div onClick={() => navigate('/user/view-trainer', { state: { trainer } })} className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-buttonBgColor dark:text-textColor hover:bg-transparent hover:border  border-redBorder cursor-pointer">
