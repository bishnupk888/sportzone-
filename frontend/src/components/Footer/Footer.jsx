...
const Footer = () => {
  return (
    <footer className=" px-4 dark:bg-black dark:text-textColor border-t border-b border-gray-300 dark:border-gray-700">
  ...
  />
				...
				<span className="self-center text-2xl font-semibold">SportZone</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-textColor">Services</h3>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2024 SportZone Co. All rights reserved.</div>
</footer>
  )
}
