...
const AreaChartCard = () => {
  const options = {
    ...
    fill: {
      ...
      gradient: {
        opacityFrom: 0.55,
        opacityTo: 0,
        shade: "#750000", // Dark red shade
        gradientToColors: ["#750000"], // Dark red
      },
    },
    dataLabels: {
      enabled: false,
    ...
    stroke: {
      width: 6,
      colors: ["#750000"], // Dark red stroke color
    },
    grid: {
      show: false,
      strokeDashArray: 4,
    ...
    series: [
      {
        ...
        color: "#750000", // Dark red series color
      },
    ],
    xaxis: {
  ...
  return (
    <div className="max-w-sm w-full bg-white rounded-lg shadow dark:bg-black border border-redBorder p-4 md:p-6">
